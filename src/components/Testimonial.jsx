...
const Testimonial = () => {
  return (
    <section className="bg-[#F7F9FD] px-10  mt-5">
      <div className="container mx-auto py-32 grid grid-cols-2 items-center">
        ...
        <div>
          ...
          >
            <SwiperSlide className="flex flex-col border">
              <p className="text-gray-500 p-3">
                “Lorem ipsum dolor sit amet, consectetur adip buscing elit. Diam
                tincidunt quisque faucibus velit felis tincidunt turpis tindiam
                cidunt sit.”
              </p>
